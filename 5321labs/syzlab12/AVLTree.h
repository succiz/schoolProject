...
public:
	...
	AVLTreeType();   //default constructor; set root to NULL //destructor?
...
template <class elemType>
void AVLTreeType<elemType>::inorderTraversal() const
{
    inorder(root);
}

template <class elemType>
void AVLTreeType<elemType>::preorderTraversal() const
{
    preorder(root);
}

template <class elemType>
void AVLTreeType<elemType>::postorderTraversal() const
{
    postorder(root);
}
...
template <class elemType>
void AVLTreeType<elemType>::inorder(AVLNode<elemType> *p) const
{
    if (p != NULL)
    {
        inorder(p->llink);
...
template <class elemType>
void AVLTreeType<elemType>::preorder(AVLNode<elemType> *p) const
{
	if (p != NULL)
	{
		cout << p->info << " ";
...
template <class elemType>
void AVLTreeType<elemType>::postorder(AVLNode<elemType> *p) const
{
    if (p != NULL)
    {
        postorder(p->llink);
